...
class ColumnListSubheader extends VariableSizeSubheader {
     ...
     * columns.
     */
    private static final int MAX_ENTRIES_PER_SUBHEADER = 16345;
    ...
    private final static int OFFSET_OF_FIRST_ENTRY = 38;
    ...
    ColumnListSubheader(Sas7bdatVariablesLayout variablesLayout, int variablesOffset) {
        ...
        int totalVariablesInSubheader = Math.min(variablesRemaining, MAX_ENTRIES_PER_SUBHEADER);

        totalVariables = totalVariablesInSubheader;

        // To make it easier match up with datasets created by sas,
        // we allow for adding extra entries so that at the size of
        ...
        //
        // Setting totalEntries to a number that is much larger than totalVariables
        // causes sas to crash when reading the sas7bdat.
        totalEntries = totalVariables + 0;
    }
    ...
    @Override
    int sizeOfData() {
        return totalEntries * SIZE_OF_ENTRY + OFFSET_OF_FIRST_ENTRY - SIGNATURE_SIZE;
    }
    ...
    void writeVariableSizedPayload(byte[] page, int subheaderOffset) {
        ...
        write2(page, subheaderOffset + 26, (short) totalEntries); // length of list
        ...
        // -totalVariables to totalVariables and the absolute value of each non-zero
        ...
        //
        int offsetFromSubheaderStart = OFFSET_OF_FIRST_ENTRY;
